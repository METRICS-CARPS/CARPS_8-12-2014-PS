...
Values are a bit off -- might be due to a rounding errors?
```{r}
# # 
...
# Step 4: Run analysis
Subject-level exclusions in the following analyses taken from paper (pg.2202) "Only participants for whom both d′1 and d′2 could be computed for the analysis subset (i.e., who had nonzero counts in every cell) were included; above chance: n = 165, at chance: n = 33." However, we cannot reproduce the nunmber of subjects included in any of the analyses.
